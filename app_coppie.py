<!-- INIZIO BLOCCO: Dashboard Torneo / Biliardini (Super Colorata & Moderna) -->
<div style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background: linear-gradient(135deg, #f5f7fa 0%, #e4e8f0 100%); border-radius: 16px; padding: 20px; max-width: 480px; margin: 0 auto; box-shadow: 0 8px 20px rgba(0,0,0,0.08); color: #2d3748;">
  ...
  <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; padding: 18px; color: white; margin-bottom: 20px; box-shadow: 0 4px 12px rgba(102,126,234,0.3);">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
      <span style="background: rgba(255,255,255,0.2); padding: 4px 12px; border-radius: 20px; font-size: 13px; font-weight: 600; letter-spacing: 0.5px;">📁 Girone B</span>
      <span style="background: #48bb78; color: white; padding: 4px 12px; border-radius: 20px; font-size: 13px; font-weight: bold; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">🏆 1° Posto</span>
    </div>
    <div style="display: flex; justify-content: space-between; font-size: 14px; font-weight: 500;">
      <span>Punti: <strong>6 pt</strong></span>
      <span>Differenza Reti (DR): <strong style="color: #9ae6b4;">+14</strong></span>
    </div>
  </div>

  <!-- PULSANTE SPECIALE: ANDAMENTO PERSONALE DELLA COPPIA -->
  <div style="margin-bottom: 24px; text-align: center;">
    <a href="#andamento" onclick="alert('📈 Caricamento dell\\'andamento personale della coppia: grafici dei progressi e statistiche in tempo reale!'); return false;" style="display: block; background: linear-gradient(135deg, #ff7e5f 0%, #feb47b 100%); color: white; text-decoration: none; padding: 16px 20px; border-radius: 12px; font-weight: bold; font-size: 16px; box-shadow: 0 6px 15px rgba(255,126,95,0.4); transition: transform 0.2s;">
      🔥 Il Mio Andamento Gara (Clicca e Scopri)
    </a>
    <p style="margin: 8px 0 0 0; font-size: 12px; color: #718096;">
      Visualizza qui lo storico dettagliato, i grafici di rendimento e l'andamento della tua coppia.
    </p>
  </div>

  <!-- LE TUE PARTITE (RIMANENTI E FATTE) -->
  <div style="background: white; border-radius: 12px; padding: 16px; margin-bottom: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
    ...
    <!-- Partite da giocare / in coda -->
    <div style="margin-bottom: 14px;">
      <span style="font-size: 13px; font-weight: bold; color: #dd6b20; display: block; margin-bottom: 6px;">⏳ Partite che mancano (In Coda):</span>
      <div style="background: #fffaf0; border: 1px dashed #ed8936; border-radius: 8px; padding: 10px; font-size: 13px; color: #c05621; text-align: center;">
        <strong>Balzo Lisa vs Marco & Luca</strong> (Da giocare)
      </div>
    </div>

    <!-- Partite già effettuate -->
    <div>
  ...
  <div style="background: white; border-radius: 12px; padding: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 13px; text-align: left;">
      ...
      <tbody>
        <!-- Riga Evidenziata per la tua squadra -->
